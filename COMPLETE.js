...
console.log("API Rate Limit Quota Database - Complete Setup");
...
console.log("  1. Creating 'developers' collection...");
load("schema/developers.js");

console.log("  2. Creating 'quota_plans' collection...");
load("schema/quota_plans.js");

console.log("  3. Creating 'api_keys' collection...");
load("schema/api_keys.js");

console.log("  4. Creating 'usage_buckets' collection...");
load("schema/usage_buckets.js");

console.log("  5. Creating 'overage_events' collection...");
load("schema/overage_events.js");

console.log("  6. Creating 'audit_logs' collection...");
load("schema/audit_logs.js");

console.log("\nSchema setup complete!\n");

// SEED SAMPLE DATA
console.log("PHASE 2 - SAMPLE DATA SEEDING");
console.log("─".repeat(70) + "\n");
...
// PHASE 3: RUN QUERIES
console.log("PHASE 3 - QUERIES & EXAMPLES");
console.log("─".repeat(70) + "\n");
...
// COMPLETION
console.log("COMPLETE! Database setup and all queries executed")