...
db.audit_logs.insertMany([
  //  Developer onboarding 
  {
    ...
    targetType: "developer", targetId: dev("claire@quantleaf.com"),
  ...
  {
    actorType: "developer", actorId: dev("michael.davidson@gmail.com"), action: "developer.self_signup",
    targetType: "developer", targetId: dev("michael.davidson@gmail.com"),
  ...
  //  API key creation 
  {
    actorType: "developer", actorId: dev("claire@quantleaf.com"), action: "api_key.create",
  ...
  {
    actorType: "developer", actorId: dev("james.smith@nimbusforge.io"), action: "api_key.create",
  ...
  //  API key revocations 
  {
    actorType: "developer", actorId: dev("claire@quantleaf.com"), action: "api_key.revoke",
  ...
  {
    actorType: "developer", actorId: dev("james.smith@nimbusforge.io"), action: "api_key.revoke",
  ...
  //  Read events 
  {
    actorType: "developer", actorId: dev("claire@quantleaf.com"), action: "usage.report_view",
    targetType: "developer", targetId: dev("claire@quantleaf.com"),
