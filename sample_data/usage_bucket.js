// ============================================================
// USAGE BUCKETS - tracking minute/hour/day windows for active keys
// Mix of light, normal, and heavy users
// ============================================================
const keyByHash = (h) => db.api_keys.findOne({ keyHash: h });

// Helper: build a bucket
...
db.usage_buckets.insertMany([
    // ===== Priya Iyer / QuantLeaf - Enterprise heavy traffic =====
    ...
    // ===== Free: Rohan's 2nd key (hit free daily limit!) =====
