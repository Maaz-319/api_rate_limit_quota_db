// ============================================================
// OVERAGE EVENTS - violations & enforcement actions
// Mostly Free/Basic abusers + a couple Pro daily-cap hits
// ============================================================
...
db.overage_events.insertMany([
    // --- Rohan Mehta (Free) - repeatedly hitting daily limit ---
    ...
    // --- Aarav Sharma / NimbusForge (Pro) - one-time burst spike ---
